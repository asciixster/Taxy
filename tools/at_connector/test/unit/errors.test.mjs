...
test('error taxonomy exposes every stable connector code', () => {
  assert.deepEqual(Object.values(AtErrorCode), [
    ...
    'INVALID_USERNAME', 'CUSTOMER_TAX_ID_MISMATCH', 'LIVE_TEST_DISABLED',
    'RATE_LIMIT_EXCEEDED', 'FACTINTWS_DIGEST_NOT_READY',
    'FACTINTWS_OPERATION_SCHEMA_UNKNOWN', 'FACTINTWS_CHANNEL_VALUES_UNKNOWN',
    'NTP_TIME_UNAVAILABLE', 'SOAP_PROTOCOL_ERROR', 'AUTH_ERROR',
    'AUTHORIZATION_ERROR', 'BUSINESS_ERROR', 'PARSING_ERROR',
    'UNKNOWN_RESPONSE', 'SUCCESS_EMPTY_RESULT', 'SUCCESS_NON_EMPTY_RESULT',
  ]);
});
