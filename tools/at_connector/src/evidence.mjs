...
export const historicalProtocolEvidence = Object.freeze([
  ...
  new AtProtocolEvidence({ field: 'namespace', value: 'http://factemi.at.min_financas.pt/fatshareInvoices', sourceUrl: null, sourceTitle: 'Single-variable namespace candidate reported by prior AT SOAP fault', documentVersion: '0.7.2 experiment', section: 'InvoicesRequest namespace', verifiedAt: VERIFIED_AT, status: EvidenceStatus.HISTORICAL_CODE_EVIDENCE, notes: 'Experimental value on the historical path; acceptance and runtime confirmation remain unproven.' }),
