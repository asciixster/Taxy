export const AtErrorCode = Object.freeze({
  ...
  FACTINTWS_DIGEST_NOT_READY: 'FACTINTWS_DIGEST_NOT_READY',
  FACTINTWS_OPERATION_SCHEMA_UNKNOWN: 'FACTINTWS_OPERATION_SCHEMA_UNKNOWN',
  FACTINTWS_CHANNEL_VALUES_UNKNOWN: 'FACTINTWS_CHANNEL_VALUES_UNKNOWN',
  NTP_TIME_UNAVAILABLE: 'NTP_TIME_UNAVAILABLE',
  SOAP_PROTOCOL_ERROR: 'SOAP_PROTOCOL_ERROR',
  AUTH_ERROR: 'AUTH_ERROR',
  AUTHORIZATION_ERROR: 'AUTHORIZATION_ERROR',
  BUSINESS_ERROR: 'BUSINESS_ERROR',
  PARSING_ERROR: 'PARSING_ERROR',
  UNKNOWN_RESPONSE: 'UNKNOWN_RESPONSE',
  SUCCESS_EMPTY_RESULT: 'SUCCESS_EMPTY_RESULT',
